...
//! origin, edge-a and edge-b; that is one deployment of m6 and nothing here knows it.
...
pub struct Node {
    ...
    ///
    /// **The nodes do not share a token.** Measured 2026-09-11: origin, edge-a, edge-b
...
"#
        ...
        assert_eq!(fleet.nodes[0].name, "origin");
