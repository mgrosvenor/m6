...
pub fn make_tls_server_config(
    ...
    // its own entry still to be in a 256-entry cache. syd took 648 handshakes
    ...
    //     http/1.1/external     451          90%       syd
    //     http/2/external       197           0%       syd
    //     http/2/external       157           0%       lon
    //     http/2/external       165           0%       chi
    //
    ...
    // p50 652ms on syd's http/1.1 channel against 0.77ms for a resumed one, and
