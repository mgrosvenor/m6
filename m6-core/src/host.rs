...
mod tests {
    ...
    /// Real output from origin, 2026-09-11.
    #[test]
    ...
    /// The root cgroup on an ordinary VM, which is what origin, edge-a and edge-b are.
...
mod system_tests {
    ...
    /// Real rows from origin, 2026-09-11.
    #[test]
...
enp1s0: 2929071615 3102200    0    0    0     0          0         0 3105995619 2471836    0    0    0     0       0          0\n";
    ...
    /// The real limits row from m6-http on origin: a 1024 soft limit against a
